...
This is my solution of the task "Refactor Udagram app into Microservices and Deploy". The code is here on GitHub: https://github.com/Taufi/udagram. You can find the docker hub images here: https://hub.docker.com/u/taufi. Screenshot of the application, the Kubernetes Pods and the Travis-CI results are here: https://github.com/Taufi/udagram/tree/master/Screenshots. Hope you like my solution ;-).
